...
<body class="bg-gray-100">
                ...
                <ul class="hidden md:flex space-x-16 text-lg"> <!-- Hide on small screens -->
                  ...
                  <div class="relative group hover:text-gray-300">
                    ...
                    <li class="relative group">
                        <a href="sellersOrders" class="cursor-pointer">Orders</a>
                    </li>
    ...
    <div class="container mx-auto px-4 py-8">
		...
		{
			 if (seller.getSellerEmail().equals(o.getSellerEmail()))
			 {
				 Book foundBook = null;
        ...
        <div class="max-w-xl bg-white rounded-lg shadow-md overflow-hidden mx-auto mb-4">
            <div class="px-6 py-4">
                ...
                <p class="text-sm text-gray-600 mb-2">Buyers Mail : <%=o.getBuyerEmail() %></p>
                <p class="text-sm text-gray-600 mb-2">Quantity : <%=o.getItemPrice()/ foundBook.getBookDiscountedPrice() %></p>
                <hr class="my-4 border-gray-300">
                <ul>
                	<li class="flex justify-between mb-2">
                        <span></span>
                        <a href="changeOrderStatus/<%=o.getOrderId() %>" class="inline-block px-4 py-2 rounded-lg bg-blue-500 text-white">
